...
from src.tasks.cvat.upload import main as upload
# from src.tasks.cvat.export_detection import main as export_detection
from src.tasks.cvat.export import main as export
from src.tasks.cvat.upload import main as upload
